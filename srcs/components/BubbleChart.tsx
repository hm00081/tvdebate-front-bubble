import { forceCenter, forceCollide, forceManyBody, forceSimulation, forceX, forceY, Simulation } from 'd3-force';
...
export class BubbleChart extends PureComponent<Props> {
    svg: Selection<SVGElement, BubbleNodeType, null, undefined> | null | undefined;
    ...
    renderSimulation = () => {
        const { bubbles, scale, height, width, onBubbleClick, onBubbleHover, onBubbleFocus, type } = this.props;
    ...
    joinBubbles = () => {
        ...
        this.simulation &&
            this.simulation
                ...
                .force('charge', forceManyBody<BubbleNodeType>().strength(this.defaultCharge))
    ...
    joinBubblesByType = () => {
        ...
        this.simulation &&
            this.simulation
                ...
                .force('collide', null)
                .force('center', null)
                .force('charge', forceManyBody<BubbleNodeType>().strength(this.weakCharge))
                .restart();
    };
    ...
    handleTooltipBlur = () => {
        ...
        tooltipForBubbleId && tooltipForType && this.bubbleDrawer && this.bubbleDrawer.focus(tooltipForBubbleId.toString(), tooltipForType);
    };

    render() {
        const { height, type, onBubbleClick, onBubbleFocus, onBubbleHover, scale, selectedId, bubbles, tooltipForBubbleId, tooltipForType, width, ...props } = this.props;
        console.log(props);
        return (
            <div aria-controls="bubbleChartTabPanel" onClick={this.handleMouseLeave} onMouseLeave={this.handleMouseLeave} tabIndex={-1} {...props}>
                <svg focusable="false" height={height} ref={this.setSVGRef} viewBox={`0 0 ${width} ${height}`} width="100%" />
            </div>
        );
    }
}
